package 코딩테스트.프로그래머스.트라이.다시풀기.가사검색;
...
public class Solution {
    ...
    public int[] solution(String[] words, String[] quries){
        Node trie = new Node();
    ...
    public static void main(String[] args) {
        ...
        solution.solution(new String[]{"frodo", "front", "frost", "frozen", "frame", "kakao"}, new String[]{"fro??", "????o", "fr???", "fro???", "pro?"});
    }
}
